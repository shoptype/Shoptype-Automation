Feature: Age Restricted and Adult Content Filter Set
  ...
  Scenario: Coseller Sign Up
	...
	@api
	Scenario: Import product from shopify with age restricted and adult content filters
		...
		And Both age restricted and adult content filter should be updated
